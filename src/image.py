...
def getCenters(prediction):
    ...
    for text in prediction:
        ...
        center = (center[0] / len(text[0]), center[1] / len(text[0]))
        centers.append((text[1], center))
    return centers

def distinguishLines(prediction, thresh=10):
    lines = []
...
class Image:
    ...
    def readTextFrom(self):
        ...
        prediction = reader.readtext(self.image)
